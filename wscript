...
def build(bld):
  ...
  obj.target = 'binding'
  obj.source = "./src/fb-bindings.cc ./src/fb-bindings-connection.cc ./src/fb-bindings-eventblock.cc ./src/fb-bindings-fbeventemitter.cc ./src/fb-bindings-fbresult.cc"
  obj.uselib = "FB"
